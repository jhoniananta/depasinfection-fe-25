...
export default function StepDone() {
  return (
    <>
      <Title title="Revision Successful" desc="Thank you!" />
      <Typography
        variant="p"
        font="Rubik"
        className="text-justify text-[14px] text-neutral-900"
      >
        We have received your revision and admin team will verify again your
        administration data. You can also refer to OKGD Dashboard to view your
        registration status.
      </Typography>
      ...
      >
        <Link href="/dashboard/okgd">Go to dashboard</Link>
      </Button>
    </>
  );
}
