...
import { useChangeStatusOKGD } from "../../_hooks/@put/useChangeStatus";
...
export default withAuth(DetailOKGDUser, "ADMIN");
function DetailOKGDUser() {
  ...
  const changeStatusMutation = useChangeStatusOKGD();
  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <Sidebar title="OKGD Admin Details Participant">
